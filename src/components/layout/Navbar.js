...
const Navbar = (
        ...
        const authUserLinks = (
            ...
            <Fragment class="navbar navbar-dark bg-dark">
                <Link className="nav-logo" to="/appointment">
                Doctor2U<img className="nav-log-img" style={{width: "3.2rem"}} src={require("./doctor (1).png")} />       
                </Link>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item active">
                            <Link to="/profiles" className="nav-link">Doctors List</Link>
                        </li>
                        <li className="nav-item active">
