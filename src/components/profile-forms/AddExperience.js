                    ...
                    <div style={{height: "auto"}} class="common-form">
                            <div className="form-side">
                                ...
                                <form onSubmit={e => {
                                    ...
                                    <input type="submit" className="btn btn-outline-info  d-grid gap-2 col-6 mx-auto btn-lg" />{' '}
                                    <Link to="/dashboard" type="submit" className="btn btn-outline-info  d-grid gap-2 col-6 mx-auto btn-lg mt-3">Go Back</Link>
                                </form>
                                <br />
                            </div>
