...
export const getProfileById = doctorId => async dispatch => {
    try {
        const res = await axiosInstance.get(`/api/profile/doctor/${doctorId}`);        
        dispatch({
...
export const deleteExperience = exp_id => async dispatch => {
    try {
        const res = await axiosInstance.delete(`api/profile/experience/${exp_id}`);
        dispatch({
            type: UPDATE_PROFILE,
            payload: res.data
        });
...
export const deleteEducation = edu_id => async dispatch => {
    try {
        const res = await axiosInstance.delete(`api/profile/education/${edu_id}`);
        dispatch({
            type: UPDATE_PROFILE,
            payload: res.data
        });
...
export const addReview = (doctorId, formData) => async dispatch => {
    ...
    try {
        const res = await axiosInstance.post(`/api/profile/doctor/:${doctorId}`, formData, config);
        dispatch({
            type: ADD_REVIEW,
            payload: res.data
        });
...
export const deleteReview = (doctorId, reviewId) => async dispatch => {
    try {
         await axiosInstance.delete(`/api/profile/doctor/${doctorId}/${reviewId}`);
